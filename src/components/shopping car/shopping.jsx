      ...
      prevCarrito.map((producto) => {
        if (producto.id === id) {
          if (producto.cantidad >= producto.cantidad_disponible) {
            // Mostrar notificación si se alcanza el límite disponible
            toast.error(
              `No puedes agregar más de ${producto.cantidad_disponible} unidades de ${producto.nombre_producto}.`
            );
            return producto; // No se modifica el producto
          }
          return { ...producto, cantidad: producto.cantidad + 1 }; // Incrementar cantidad
        }
        return producto;
      })
    );
    ...
    try {
      ...
      const pedidoDetalles = {
        ...
        mensaje: `
                          ...
                          return `
                              <tr style="background-color: ${
                                producto.cantidad % 2 === 0
                                  ...
                                  <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">$${producto.precio.toFixed(
                                    2
                                  )}</td>
                                  <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">$${(
              ...
              <h3 style="color: #000000;">Total de la compra: $${calcularTotal().toFixed(
                2
              )}</h3>
